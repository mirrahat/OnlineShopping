...
namespace OnlineShoppingStore.Repository
{
    public class GenericRepository<Tbl_Entity> : IRepository<Tbl_Entity> where Tbl_Entity : class
    {
        ...
        private OnlineShoppingStoreEntities1 _DBEntity;

        public GenericRepository(OnlineShoppingStoreEntities1 DBEntity) {
            _DBEntity = DBEntity;
        ...
        public void InAciveAndDeleteMarkByWhereClause(Expression<Func<Tbl_Entity, bool>> wherePredict, Action<Tbl_Entity> ForEachPredict)
        {
        ...
        public IEnumerable<Tbl_Entity> GetRecordsToShow(int PageNo, int PageSize, int CurrentSize, Expression<Func<Tbl_Entity, bool>> wherePredict, Expression<Func<Tbl_Entity, int>> OrderByPredict)
        {
        ...
        IEnumerable<Tbl_Entity> IRepository<Tbl_Entity>.GetProducts()
        {
            return _dbSet.ToList();
        }
    }
